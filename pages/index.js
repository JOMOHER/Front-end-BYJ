  ...
  return (
    <>
      <Head>
        ...
        ></link>
        <link
          href="https://fonts.googleapis.com/css2?family=Alex+Brush&family=Montserrat:wght@500&family=Playfair+Display&display=swap"
          rel="stylesheet"
        />
      </Head>
      ...
      <header className="hero">
        ...
        <p>
          Tenemos el gusto de invitarlos a nuestro enlace matrimonial, con la
          bendicion de DIOS, nuestros padres, hermanos y seres queridos.
        </p>
      ...
      <section className="detalles">
        ...
        <p>
          <strong>Fecha:</strong> 13 de Diciembre de 2025
        </p>
        <p>
      ...
      <section className="detalles">
        <h2>Asistencia / Mesa de regalos</h2>
        <div className="button-container">
          ...
          <div className="boton-con-icono">
          <img src="/img/gift.svg" alt="Confirmacion" className="icono" />
          <a
            href="https://maps.app.goo.gl/219x1PZCheMR7wWe6?g_st=com.google.maps.preview.copy"
            target="_blank"
            rel="noopener noreferrer"
